                    ...
                    <div class="col-lg-5">
                        <div class="map-area">
                            ...
                            <div class="single-content">
                                <ul>
                                    <li>
                                        US : <a href="tel:123456789">+1 23456789</a>
                                    </li>
                                    <li>
                                        FR : <a href="tel:123456789">+1 23456789</a>
                                    </li>
                                    <li>
                                        UK : <a href="tel:123456789">+1 23456789</a>
                                    </li>
                                </ul>
...
@push('scripts')
<script>
    // Reinitialize counter animations on page load
