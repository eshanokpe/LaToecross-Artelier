...
new class extends Component
{
    ...
    public function getArtworksProperty()
    {
        ...
        if ($this->category !== 'all') {
            $query->where('style', $this->category);
        }
...
<div class="artworks-catalog-wrapper">
    <!-- Catalog Section -->
                        ...
                        <div class="sidebar-area space-y-6">
                            ...
                            <div class="single-widgets bg-white rounded-2xl shadow-lg p-6">
                                <div class="widget-title mb-4">
                                    <h5 class="font-bold text-lg" style="color: #1a0a0f;">Search</h5>
                                </div>
                            ...
                            <!-- Statistics -->
                            <div class="single-widgets bg-gradient-to-r from-pink-50 to-pink-100 rounded-2xl p-6" style="background: linear-gradient(135deg, #fce4ec, #faf0f5);">
                                <div class="text-center">
                                    <div class="text-3xl font-bold" style="color: #DB2077;">{{ $this->totalCount }}</div>
                                    <p class="text-sm" style="color: #6b3b4f;">Total Artworks Available</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex flex-wrap items-center justify-between gap-4 mb-6 bg-white rounded-2xl shadow-lg p-4">
                            <div>
                                <h6 class="text-sm" style="color: #6b3b4f;">
                                    Showing 
                                    <span class="font-bold" style="color: #DB2077;">{{ $this->artworks->firstItem() ?? 0 }}</span>
                                    of 
                                    <span class="font-bold" style="color: #DB2077;">{{ $this->artworks->total() }}</span>
                                    results
                                </h6>
                            </div>
                                ...
                                <div class="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden {{ $viewMode === 'list' ? 'flex flex-col sm:flex-row' : '' }}">
                                    ...
                                    <div class="p-2 flex-1 flex flex-col">
                                        <h6 class="font-bold line-clamp-1" style="color: #1a0a0f;">
                                            <a href="{{ route('artwork.show', \Vinkla\Hashids\Facades\Hashids::encode($artwork->id)) }}" class="hover:underline">
                                                {{ $artwork->title }}
                                            </a>
                                        </h6>
                            ...
                            @empty
                                <div class="col-span-full text-center py-16 bg-white rounded-2xl shadow-lg">
                                    ...
                                    <p class="text-gray-600" style="color: #6b3b4f;">
                                        ...
                                        @else
                                            No artworks are available at the moment.
                                        @endif
                                    </p>
                                    <button wire:click="clearFilters" 
