            ...
            <div class="max-w-7xl mx-auto">
                <div class="grid lg:grid-cols-2 gap-12 lg:gap-16">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-2 gap-2 sm:flex sm:flex-wrap sm:gap-4 pt-2">
                            
                            <button wire:click="openEnquiryModal" 
                                    class="w-full sm:flex-1 text-center px-3 sm:px-6 py-2.5 sm:py-3 rounded-xl font-semibold transition-all duration-300 hover:shadow-xl hover:scale-105 flex items-center justify-center gap-2 text-xs sm:text-base"
